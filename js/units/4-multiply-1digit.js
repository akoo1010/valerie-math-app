        ...
        return [
            // 1. Multiply 2-digit × 1-digit (no regrouping at diff 1)
            {
                ...
                generate(diff, modality) {
                    ...
                    const result = {
                        ...
                        hint2: `${Math.floor(a / 10) * 10} × ${b} = ${Math.floor(a / 10) * 10 * b}, then ${a % 10} × ${b} = ${(a % 10) * b}`,
                        hint3: `${a} × ${b} = ${answer}`,
                        diagnose(userAnswer) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 34 × 3 = ?</p><p>Step 1: 4 × 3 = 12 (write 2, carry 1)</p><p>Step 2: 3 × 3 = 9, plus carried 1 = 10</p><p>Answer: <strong>102</strong></p></div>`;
                    }
                    ...
                    if (modality === 'visual') {
                        ...
                        result.visual = `<div style="text-align:center;">
                            ...
                            <div style="margin-top:10px;font-weight:700;color:var(--monster-purple);font-size:1.1rem;">🔥 ${tensA * b} + ${onesA * b} = ?</div>
                        </div>`;
                    }
            ...
            // 2. Multiply 3-digit × 1-digit
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 253 × 4 = ?</p><p>3 × 4 = 12 → write 2, carry 1</p><p>5 × 4 = 20 + 1 = 21 → write 1, carry 2</p><p>2 × 4 = 8 + 2 = 10</p><p>Answer: <strong>1,012</strong></p></div>`;
                    }
            ...
            // 3. Multiply 4-digit × 1-digit
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 1,234 × 3 = ?</p><p>4 × 3 = 12 → write 2, carry 1</p><p>3 × 3 = 9 + 1 = 10 → write 0, carry 1</p><p>2 × 3 = 6 + 1 = 7</p><p>1 × 3 = 3</p><p>Answer: <strong>3,702</strong></p></div>`;
                    }
            ...
            // 4. Word problems
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 5 boxes of 24 items each</p><p>24 × 5 = (20 × 5) + (4 × 5) = 100 + 20 = <strong>120</strong></p></div>`;
                    }
            ...
            // 5. Estimate products by rounding
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> Estimate 47 × 6</p><p>Step 1: Round 47 → 50</p><p>Step 2: 50 × 6 = <strong>300</strong></p><p>The estimate is 300!</p></div>`;
                    }
            ...
            // 6. Area model / distributive property
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 36 × 4</p><p>30 × 4 = 120</p><p>6 × 4 = 24</p><p>120 + 24 = <strong>144</strong></p></div>`;
                    }
            ...
            // 7. Monster Boss Battle — mixed
            {
                ...
                generate(diff, modality) {
                    ...
                    if (modality === 'worked-example') {
                        result.workedExample = `<div style="text-align:center"><p><strong>Example:</strong> 246 × 7 = ?</p><p>6 × 7 = 42 → write 2, carry 4</p><p>4 × 7 = 28 + 4 = 32 → write 2, carry 3</p><p>2 × 7 = 14 + 3 = 17</p><p>Answer: <strong>1,722</strong></p></div>`;
                    }
                    ...
                    if (modality === 'visual') {
                        ...
                        result.visual = `<div style="text-align:center;">
                            ...
                            <div style="margin-top:8px;font-weight:700;color:var(--monster-purple);font-size:1.1rem;">🗡️ ${tensA * b} + ${onesA * b} = ?</div>
                        </div>`;
                    }
